...
Simple ray tracer created for fun and to develop object programming skills.
...
Lib does not have any pre-made classes to draw on scene. User must declare his own objects inheriting from `Object` class and overwrite
...
- `.exist` type `bool` (should contain result of intersection test, exactly the same what method return)
...
`Scene` class is the core of algorithm. It contains information about all objects and lights on screen.
