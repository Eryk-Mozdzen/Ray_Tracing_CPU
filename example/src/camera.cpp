...
void Camera::move() {
    ...
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::W))         translation +=rtrace::Vector3::X;
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::S))         translation -=rtrace::Vector3::X;
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::A))         translation +=rtrace::Vector3::Y;
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::D))         translation -=rtrace::Vector3::Y;
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::LShift))    translation +=rtrace::Vector3::Z;
    if(sf::Keyboard::isKeyPressed(sf::Keyboard::LControl))  translation -=rtrace::Vector3::Z;
